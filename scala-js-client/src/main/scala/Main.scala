...
object Main extends App {
  val elements = Map(
    ...
    //    Index page
    "bigLearnMore" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    "secondLearnMore" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    "thirdLearnMore" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    ...
    "learnMore4" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    ...
    "learnMore5" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    "exhibition2" -> Array("Exhibition", "Выставка", "Ko'rgazma"),
    ...
    "learnMore6" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    "exhibition3" -> Array("Exhibition", "Выставка", "Ko'rgazma"),
    ...
    "learnMore7" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    ...
    "learnMoreGallery" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    ...
    "learnMoreDisplay2" -> Array("Learn More", "Учить больше", "Batafsil ma\'lumot"),
    ...
    "month2" -> Array("December", "Декабрь", "Dekabr"),
    "weekday2" -> Array("SATURDAY", "СУББОТА", "SHANBA"),
    "eventName2" -> Array("Reduis Maroa", "Редуис Мароа", "Reduis Maroa"),
    "eventLink2" -> Array("Renaissance to Revolution", "От Возрождения до революции", "Inqilobning Uyg'onishi"),
    "eventDate2" -> Array("November 30, 2021 - November 28, 2020", "30 ноября 2021 - 28 ноября 2020", "30 - noyabr, 2021 yil - 28 - noyabr, 2020 - yil"),
    "findMore2" -> Array("Find More", "Найти еще", "Ko'proq izlash"),
    "month3" -> Array("November", "Ноябрь", "Noyabr"),
    "weekday3" -> Array("SATURDAY", "СУББОТА", "SHANBA"),
    "eventName3" -> Array("Central Park", "Центральный парк", "Markaziy Park"),
    "eventLink3" -> Array("Buffalo Bill Museum & Grave", "Музей и могила Буффало Билла", "Buffalo Bill muzeyi va qabr"),
    "eventDate3" -> Array("November 30, 2021 - November 28, 2020", "30 ноября 2021 - 28 ноября 2020", "30 - noyabr, 2021 yil - 28 - noyabr, 2020 - yil"),
    "findMore3" -> Array("Find More", "Найти еще", "Ko'proq izlash"),
    "month4" -> Array("December", "Декабрь", "Dekabr"),
    "weekday4" -> Array("SATURDAY", "СУББОТА", "SHANBA"),
    "eventName4" -> Array("Reduis Maroa", "Редуис Мароа", "Reduis Maroa"),
    "eventLink4" -> Array("Renaissance to Revolution", "От Возрождения до революции", "Inqilobning Uyg'onishi"),
    "eventDate4" -> Array("November 30, 2021 - November 28, 2020", "30 ноября 2021 - 28 ноября 2020", "30 - noyabr, 2021 yil - 28 - noyabr, 2020 - yil"),
    "findMore4" -> Array("Find More", "Найти еще", "Ko'proq izlash"),
    "month5" -> Array("November", "Ноябрь", "Noyabr"),
    "weekday5" -> Array("SATURDAY", "СУББОТА", "SHANBA"),
    "eventName5" -> Array("Central Park", "Центральный парк", "Markaziy Park"),
    "eventLink5" -> Array("Buffalo Bill Museum & Grave", "Музей и могила Буффало Билла", "Buffalo Bill muzeyi va qabr"),
    "eventDate5" -> Array("November 30, 2021 - November 28, 2020", "30 ноября 2021 - 28 ноября 2020", "30 - noyabr, 2021 yil - 28 - noyabr, 2020 - yil"),
    "findMore5" -> Array("Find More", "Найти еще", "Ko'proq izlash"),
    "month6" -> Array("December", "Декабрь", "Dekabr"),
    "weekday6" -> Array("SATURDAY", "СУББОТА", "SHANBA"),
    "eventName6" -> Array("Reduis Maroa", "Редуис Мароа", "Reduis Maroa"),
    "eventLink6" -> Array("Renaissance to Revolution", "От Возрождения до революции", "Inqilobning Uyg'onishi"),
    "eventDate6" -> Array("November 30, 2021 - November 28, 2020", "30 ноября 2021 - 28 ноября 2020", "30 - noyabr, 2021 yil - 28 - noyabr, 2020 - yil"),
    "findMore6" -> Array("Find More", "Найти еще", "Ko'proq izlash"),
    "findMore6" -> Array("Find More", "Найти еще", "Ko'proq izlash"),
    ...
    "modernArt2" -> Array("Exhibition of Modern Art", "Выставка современного искусства", "Zamonaviy san\'at ko\'rgazmasi"),
    "readMore2" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
    "modernArt3" -> Array("Exhibition of Modern Art", "Выставка современного искусства", "Zamonaviy san\'at ko\'rgazmasi"),
    "readMore3" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
    "readMore4" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
    "modernArt5" -> Array("Exhibition of Modern Art", "Выставка современного искусства", "Zamonaviy san\'at ko\'rgazmasi"),
    "readMore5" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
    "modernArt6" -> Array("Exhibition of Modern Art", "Выставка современного искусства", "Zamonaviy san\'at ko\'rgazmasi"),
    "readMore6" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
    "modernArt7" -> Array("Exhibition of Modern Art", "Выставка современного искусства", "Zamonaviy san\'at ko\'rgazmasi"),
    "readMore7" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
    "modernArt8" -> Array("Exhibition of Modern Art", "Выставка современного искусства", "Zamonaviy san\'at ko\'rgazmasi"),
    "readMore8" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
    "modernArt9" -> Array("Exhibition of Modern Art", "Выставка современного искусства", "Zamonaviy san\'at ko\'rgazmasi"),
    "readMore9" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
    "modernArt10" -> Array("Exhibition of Modern Art", "Выставка современного искусства", "Zamonaviy san\'at ko\'rgazmasi"),
    "readMore10" -> Array("Read More", "Подробнее", "Ko\'proq o\'qish"),
